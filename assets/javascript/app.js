...
var quizQ = [{
    ...
    },
    {
        ...
        choices: ['Love it!', 'Nope!', 'None of the above'],
        correctAnsw: "None of the above!"
    },
    {
...
// function is responsible for what happens after button start/do it again clicked --> clears all scores
//and showing first question
$(document).on('click', "#start, #restart", function() {
    correctA = 0;
    incorrectA = 0;
    unansweredQ = 0;
    counterQ = 0;
...
function showFinalScore() {
    ...
    $("#result").remove();
    $("button").remove();
    $("div").append("<img src ='assets/images/donut.jpg'>")
    $("div").append("<h2>");
    $("h2").text("Final score:");
    $("div").append("<p>");
    ...
    $("div").append("<button id='restart'>");
    $("#restart").text("Do it again");
}